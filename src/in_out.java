...
//    }
    ...
    public void input_kondisi_ruang_kelas() {
        ...
        //  j.hitung_luas_ruang();
        f = new ruang(d.getPanjang_ruang(), d.getLebar_ruang(), d.getJumlah_kursi(), d.getJumlah_pintu(), d.getJumlah_jendela());
    }
//@Override
...
//        }
        ...
        f = new ruang (d.getJumlah_steker(),d.getKondisi_steker(),d.getPosisi_steker(),
                d.getJumlah_kabel_LCD(),d.getKondisi_kabel_LCD(),d.getPosisi_kabel_LCD(),
