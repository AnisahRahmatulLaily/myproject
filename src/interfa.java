...
public interface interfa {
    ...
    void output(int panjang_ruang,int lebar_ruang, int jumlah_kursi, int jumlah_pintu, int jumlah_jendela);
    void output(int jumlah_steker, String kondisi_steker, String posisi_steker, int jumlah_kabel_LCD, 
    ...
    void output(String kondisi_lantai, String kondisi_dinding, String kondisi_atap, String kondisi_pintu, String kondisi_jendela);
    void output(String sirkulasi_udara, int pencahayaan, int kelembapan, int suhu);
    void output(int kebisingan, String bau, String kebocoran, String kerusakan, String keausan);
    void output(String kekokohan, int jumlah_kunci, int jumlah_jendela, String bahaya);
